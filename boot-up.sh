...
PACKAGES="tmux go gh neovim lf difftastic node direnv fzf act glow fd ripgrep bat tree z eza tfenv awscli urlview zsh-syntax-highlighting shellcheck azure-cli corepack terminal-notifier lazygit lazydocker delve postgresql@15"
